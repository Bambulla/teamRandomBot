...
HELP_TEXT = """прив, это бот для коллег: ра [бот] аем.

Я помогаю наводить мосты между коллегами внутри Рокета: раз в неделю собираю случайные пары для 30-минутного общения.

Команды:
/start или /help — показать описание бота
/poll — прислать опрос об участии
...
/week — показать пары этой недели
